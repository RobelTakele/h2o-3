...
def test_beta_constraints_gaussian():
    ...
    run_print_model_performance('gaussian', h2o_data, nfolds, None, x, y, "no beta constraints", seed, 'coordinate_descent')
    ...
    constraints = h2o.H2OFrame({'names': ["C1.0", "C11"], 'lower_bounds': [0.3696965402743819*0.1, 10.20086488314071*0.1],
    ...
    constraints = h2o.H2OFrame({'names': ["C1.0", "C2.0", "C3.0", "C11", "C12", "C13"],
                                'lower_bounds': [0.3696965402743819*0.1, 3.8273867830358252*0.1, 2.2831399185698835*0.1,
                                                 10.20086488314071*0.1, 2.9111423805443195*0.1, 20.130364463336967*0.1],
                                'upper_bounds': [0.3696965402743819*0.8, 3.8273867830358252*0.8, 2.2831399185698835*0.8,
                                                 10.20086488314071*0.8, 2.9111423805443195*0.8, 20.130364463336967*0.8]})
    constraints = constraints[["names", "lower_bounds", "upper_bounds"]]
    run_print_model_performance('gaussian', h2o_data, nfolds, constraints, x, y, printText, seed, 'coordinate_descent')
    run_print_model_performance('gaussian', h2o_data, nfolds, constraints, x, y, printText, seed, 'irlsm')
